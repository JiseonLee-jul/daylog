...
*Sources: 9 | Concepts: 25 | Connections: 17*
...
- [260416_claude-code-vs-codex-comparison](summaries/260416_claude-code-vs-codex-comparison.md) — Claude Code(100h) vs Codex(20h) 실전 비교: 속도 vs 완결성, 교차 검증 워크플로우가 지배적 사용 패턴
...
- [claude-code](concepts/claude-code.md) — Anthropic의 터미널 기반 코딩 에이전트 플랫폼 (제품 개요 + 실전 행동 특성)
...
- [cross-validation-workflow](concepts/cross-validation-workflow.md) — 다중 LLM 에이전트 교차 검증 패턴 (Claude draft ↔ Codex review)
...
- [openai-codex](concepts/openai-codex.md) — Claude Code용 OpenAI Codex 플러그인 + 실전 행동 특성
...
- [claude-code ↔ cross-validation-workflow](connections/claude-code--cross-validation-workflow.md) — Claude Code = 교차 검증 워크플로우의 초안 작성자 역할
- [claude-code ↔ openai-codex](connections/claude-code--openai-codex.md) — 경쟁 제품이지만 행동 특성이 상호 보완적 (대비 표 포함)
- [claude-code-plugin ↔ openai-codex](connections/claude-code-plugin--openai-codex.md) — 경쟁 제품 생태계에 자사 모델 통합 사례
- [cross-validation-workflow ↔ openai-codex](connections/cross-validation-workflow--openai-codex.md) — Codex = 교차 검증 워크플로우의 검토자 역할 (퍼스트파티 구현)
...
- 2026-04-16: Compiled 260416_claude-code-vs-codex-comparison (new concept: cross-validation-workflow; new connections: claude-code↔openai-codex, claude-code↔cross-validation-workflow, cross-validation-workflow↔openai-codex; updated claude-code, openai-codex with behavioral profiles)
